...
const Education = () => {
  return (
    <div id="education" className="pt-24">
      ...
      <div className="my-20">
        <div className="h-32 bg-gradient-to-r from-purple-500 to-pink-500 tablet:mx-16 rounded-lg shadow largeTablet:mx-16 medium:mx-16 mobile:mx-5">
          <WorkContent
        ...
        <div className="h-32 bg-gradient-to-r from-purple-500 to-pink-500 tablet:mx-16 rounded-lg shadow mt-10 largeTablet:mx-16 medium:mx-16 mobile:mx-5">
          <WorkContent
